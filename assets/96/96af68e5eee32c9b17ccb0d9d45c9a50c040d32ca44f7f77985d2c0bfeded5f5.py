...
import cv2
import s2_preview_core_window as candidate
import s2_preview_core_thin as base
...
Path(__file__).with_name('window_results.json').write_text(json.dumps(rows,indent=2))
