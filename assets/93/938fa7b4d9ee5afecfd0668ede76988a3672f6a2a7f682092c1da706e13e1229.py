...
import cv2
import s2_preview_core_paths as candidate
import s2_preview_core_window as base
...
Path(__file__).with_name('paths_results.json').write_text(json.dumps(rows,indent=2))
