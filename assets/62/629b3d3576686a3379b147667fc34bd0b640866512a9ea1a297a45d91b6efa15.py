...
def main():
    ...
    out = Path('second_curve_paths_5s_results')/datetime.now().strftime('%Y%m%d_%H%M%S_%f')
    out.mkdir(parents=True)
    for name in ('v2_paths_second_curve_5s.py', 'bounded_state_5s.py', 's2_preview_core_paths.py'):
