...
PWM_STEERING_THROTTLE = {
	...
	"PWM_STEERING_SCALE": 1.0,              # PWM frequency compensation
 	...
 	"STEERING_LEFT_PWM": 440,               # Calibrated value: Full Left
        "STEERING_CENTER_PWM": 350,
        "STEERING_RIGHT_PWM": 290,              # Calibrated value: Full Right
	"THROTTLE_FORWARD_PWM": 450,            # Calibrated value: Max Forward
...
# CNN automatic startup test
WEB_INIT_MODE = "local"
AI_LAUNCH_DURATION = 0.0
AI_LAUNCH_THROTTLE = 0.0
MAX_LOOPS = 100

# Phone-timed CNN trials: wait for explicit control command.
WEB_INIT_MODE = "user"
MAX_LOOPS = None
AI_LAUNCH_DURATION = 0.0
AI_LAUNCH_THROTTLE = 0.0

# Pixel evaluation: one new recording directory per server launch.
import os
from datetime import datetime
DATA_PATH = os.path.join('/home/student/projects/mycar/pixel_evaluation_20260912', 'CNN_RUN_' + datetime.now().strftime('%Y%m%d_%H%M%S_%f'))
AUTO_CREATE_NEW_TUB = False
AUTO_RECORD_ON_THROTTLE = False
RECORD_DURING_AI = True
WEB_INIT_MODE = 'user'
print('CNN IMAGE DIRECTORY:', DATA_PATH, flush=True)
