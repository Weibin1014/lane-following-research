...
The user pointed out that the green point on the sixth picture of CNN_01R1 deviated from the center of the white marking line and confirmed that the other points were accurate. According to line 78 of the original image, the white marking line approximately covers x=79 to 89. The assistant corrects the center of the right marking line from 82 to 84. The frame deviation changes from −34 to −33 px; the MSE of CNN_01R1 is updated to 445.8 px² and the RMSE is 21.1 px. The correction points have been enlarged, and the user's other point confirmation enlargements have not been interpreted as all 60 independent reviews have been completed. The original first draft is backed up.
