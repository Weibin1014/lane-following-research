...
## User review correction record

CNN_01R1 Picture 6: The center of the right marking line is 82→84. CNN_02R1 No. 4, 6, and 9: The centers of the right marking lines are 99→100, 115→120, and 99→102 respectively. Line 78 of the original image was rechecked according to the location problem pointed out by the user, and the coordinates were corrected to pixel estimates; other annotations remained unchanged. Statistics have been updated, and the corrected graph awaits user confirmation. Previous versions are kept in the before_* directories.
