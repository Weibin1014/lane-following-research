...
## Review the correction progress

The right coordinate of the sixth picture of CNN_01R1 is corrected to 84. The 4th, 6th, and 9th pictures of CNN_02R1 were corrected to 100, 120, and 102. The user has confirmed these three corrections. All the white line coordinates of CNN_03 were rechecked, and the midpoints of both ends of the local white marking line on line 78 were used. For the specific range, see CNN_03_review_corrections.json; the third picture is still 105, and the remaining positions are shown in the updated review chart. CNN_03 This round of corrections awaits user confirmation. Missing markers for other samples remained unchanged.
