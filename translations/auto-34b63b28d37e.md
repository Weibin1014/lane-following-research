...
- OpenCV_01R1: corrected points pending user confirmation; see [OpenCV_01R1_review_corrections.json](OpenCV_01R1_review_corrections.json) for details.
...
- OpenCV_03: user confirmed six corrected green markers acceptable; see [OpenCV_03_review_corrections.json](OpenCV_03_review_corrections.json) for details.
