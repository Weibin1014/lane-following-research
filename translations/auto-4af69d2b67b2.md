...
- OpenCV_02: user confirmed three corrected green markers acceptable; see [OpenCV_02_review_corrections.json](OpenCV_02_review_corrections.json) for details.
- OpenCV_03: corrected points pending user confirmation; see [OpenCV_03_review_corrections.json](OpenCV_03_review_corrections.json) for details.
